...
$(document).ready(function () {
    ...
    $("#searchCity").val(queryString.get("searchCity"));
    $("#searchTitle").val(queryString.get("searchTitle"));
    $("#searchDate").val(queryString.get("searchDate"));
    $("#searchDate").val(moment().format('YYYY-MM-DD'));
    city = queryString.get("searchCity");
    sDate = queryString.get("searchDate");
    title = queryString.get("searchTitle");
    loadEvents();
});
...
function loadEvents() {
    ...
    var settings = {
        ...
        "data": { token: 'DEF3J2HCZTGKJ6OAD6LF', sort_by: 'best', 'location.address': city, 'location.within': '10km', 'start_date.range_start': sDate + "T00:00:00Z", locale: 'en_US', expand: 'venue' },
        "method": "GET"
    }
    // START AJAX
